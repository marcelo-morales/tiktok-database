...
-- Give me back the artist names for these artists that are part of these trending songs.
...
SELECT Video.caption, Video.likeCount
    FROM Video
    GROUP BY Video.caption
    ORDER BY Video.likeCount
    LIMIT 1 ;
...
-- Return back the usernames for these profiles that fit the given description.
